...
def criar_janela():
    '''Construtor da janela de adição de livros'''
    ...
    def botao_direito_titulo(
        event
    ):
        try:
            menu_lado_direito_titulo.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    def botao_direito_autor(
        event
    ):
        try:
            menu_lado_direito_autor.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    def botao_direito_editora(
        event
    ):
        try:
            menu_lado_direito_editora.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    def botao_direito_publicacao(
        event
    ):
        try:
            menu_lado_direito_publicacao.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    def botao_direito_genero(
        event
    ):
        try:
            menu_lado_direito_genero.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    def botao_direito_isbn(
        event
    ):
        try:
            menu_lado_direito_isbn.tk_popup(
                event.x_root,
                event.y_root
            )
        finally:
    ...
    entrada_titulo.bind(
        "<Button-3>",
        botao_direito_titulo
    )
    entrada_autor.bind(
        "<Button-3>", 
        botao_direito_autor
    )
    entrada_editora.bind(
        "<Button-3>",
        botao_direito_editora
    )
    entrada_publicacao.bind(
        "<Button-3>",
        botao_direito_publicacao
    )
    entrada_genero.bind(
        "<Button-3>",
        botao_direito_genero
    )
    entrada_isbn.bind(
        "<Button-3>",
        botao_direito_isbn
